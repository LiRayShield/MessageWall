<template>
    ...
    <div class="foot-bar">
        ...
        <div class="section intro">
            <h2>青一录 - 网站介绍</h2>
            <p>&#12288;&#12288;此网站是LiRayShield、皮皮和鑫奇时代等人共同开发，数据库持有者ID用户LiRayShield、部分资金持有者皮皮和服务器ECS持有者鑫奇时代，如果发错了请及时联系墙主LiRayShield（联系方式为免责声明里面的邮箱）或其他管理人员鑫奇时代（微信：dxq13230936038）删掉，请注意用户在写留言过程中遵守相应的法律法规（在免责声明中），墙主li总是一个非常厉害的前端程序员，请注意打赏哦，1元不嫌多，100元不嫌少，墙主LiRayShield（是个大帅哥，缺男朋友的小姐姐抓紧了）和鑫奇时代都是学生。</p>
        </div>
